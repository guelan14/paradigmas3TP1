  ...
  <body>
    ...
    <main>
      ...
      <section id="menu" class="menu-section">
        ...
        <p>Descubre los sabores únicos que ofrecemos.</p>
        <div class="menu-container"></div>
      </section>
      <section class="table-section">
        <h2>Productos Rapidos</h2>
        <table>
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td>
                Un pastel de chocolate rico y húmedo hecho con el mejor cacao.
              </td>
              <td>$25.00</td>
            </tr>
            <tr>
              ...
              <td>
                Un cheesecake cremoso con una base de galleta crujiente y una
                cobertura de fresas frescas.
              </td>
              <td>$30.00</td>
            </tr>
            <tr>
              <td>Brownie con Nueces</td>
              <td>
                Brownie denso y chocolatoso, con trozos de nueces para un extra
                de textura y sabor.
              </td>
              <td>$20.00</td>
            </tr>
      ...
      <section id="about" class="about-section">
        ...
        <div class="about-content">
          <img src="imagenes/local.jpg" alt="Nuestro Restaurante" />
    ...
    <script src="scripts/special-dishes.js"></script>
  </body>
</html>
